...
conf_fn="sep_san_jose_realtor_200_100_val_dir_norm.conf"
post_sep="Batches-San-Jose-train-deep-post-code-sep-norm-1024"
val_sep="Batches-San-Jose-test-deep-post-code-sep-norm-1024"

log_dir="log_sep_val_dir_norm"
